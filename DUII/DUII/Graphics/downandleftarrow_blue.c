...
**********************************************************************
*
* Source file: downandleftarrow_blue
* Dimensions:  31 * 31
* NumColors:   2
*
**********************************************************************
...
static GUI_CONST_STORAGE GUI_COLOR Colorsdownandleftarrow_blue[] = {
     0x0000FF,0xFF0000
};

static GUI_CONST_STORAGE GUI_LOGPALETTE Paldownandleftarrow_blue = {
  2,	/* number of entries */
  1, 	/* Has transparency */
  &Colorsdownandleftarrow_blue[0]
};

static GUI_CONST_STORAGE unsigned char acdownandleftarrow_blue[] = {
...
GUI_CONST_STORAGE GUI_BITMAP bmdownandleftarrow_blue = {
  31, /* XSize */
  31, /* YSize */
  4, /* BytesPerLine */
  1, /* BitsPerPixel */
  acdownandleftarrow_blue,  /* Pointer to picture data (indices) */
  &Paldownandleftarrow_blue  /* Pointer to palette */
};
