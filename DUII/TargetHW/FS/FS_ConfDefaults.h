...
**********************************************************************
*/
#define FS_OS_LOCKING				1		// uses RTOS semaphores
#define FS_SUPPORT_BUSY_LED			0		// no LED on DUII
#define FS_SUPPORT_CACHE			1		// use the cache
#define FS_USE_FILE_BUFFER			1		// Enables file buffering, which makes file access faster and code bigger & increases ram usage
#define FS_NUM_VOLUMES				2		// 1 for SD card, 1 for either RAMdisk or Dataflash disk in future
