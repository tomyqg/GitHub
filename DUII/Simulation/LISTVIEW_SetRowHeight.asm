; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\Widget\LISTVIEW_SetRowHeight.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
;	COMDAT rtc$TMZ
; File c:\duii\simulation\gui\widget\listview_setrowheight.c
rtc$TMZ	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT _LISTVIEW_SetRowHeight
_TEXT	SEGMENT
_pObj$14699 = -20					; size = 4
_r$ = -8						; size = 4
_hObj$ = 8						; size = 4
_RowHeight$ = 12					; size = 4
_LISTVIEW_SetRowHeight PROC				; COMDAT
; Line 37
	push	ebp
	mov	ebp, esp
...
; Line 44
	mov	eax, DWORD PTR _RowHeight$[ebp]
	cmp	eax, DWORD PTR _r$[ebp]
	je	SHORT $LN2@LISTVIEW_S
; Line 45
	mov	eax, DWORD PTR _pObj$14699[ebp]
	mov	ecx, DWORD PTR _RowHeight$[ebp]
