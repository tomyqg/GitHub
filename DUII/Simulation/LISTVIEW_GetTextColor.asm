; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\Widget\LISTVIEW_GetTextColor.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
;	COMDAT rtc$TMZ
; File c:\duii\simulation\gui\widget\listview_gettextcolor.c
rtc$TMZ	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT _LISTVIEW_GetTextColor
_TEXT	SEGMENT
_pObj$14699 = -20					; size = 4
_Color$ = -8						; size = 4
_hObj$ = 8						; size = 4
_Index$ = 12						; size = 4
_LISTVIEW_GetTextColor PROC				; COMDAT
; Line 37
	push	ebp
	mov	ebp, esp
