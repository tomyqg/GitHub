; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\Widget\GUI_DRAW_BITMAP.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
__ConstObjData DD FLAT:__DrawBitmap
	DD	FLAT:__GetXSize
	DD	FLAT:__GetYSize
CONST	ENDS
...
;	COMDAT rtc$TMZ
; File c:\duii\simulation\gui\widget\gui_draw_bitmap.c
rtc$TMZ	SEGMENT
...
__GetYSize ENDP
_TEXT	ENDS
PUBLIC	_GUI_DRAW_BITMAP_Create
EXTRN	_GUI_ALLOC_AllocZero:PROC
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT _GUI_DRAW_BITMAP_Create
_TEXT	SEGMENT
_pObj$10187 = -20					; size = 4
_hMem$ = -8						; size = 4
_pBitmap$ = 8						; size = 4
_x$ = 12						; size = 4
_y$ = 16						; size = 4
_GUI_DRAW_BITMAP_Create PROC				; COMDAT
; Line 103
	push	ebp
	mov	ebp, esp
	sub	esp, 216				; 000000d8H
...
; Line 110
	...
	call	_GUI_ALLOC_LockH
	add	esp, 4
	mov	DWORD PTR _pObj$10187[ebp], eax
; Line 111
	mov	eax, DWORD PTR _pObj$10187[ebp]
...
; Line 115
	call	_GUI_ALLOC_UnlockH
	mov	DWORD PTR _pObj$10187[ebp], 0
$LN2@GUI_DRAW_B:
; Line 119
	mov	eax, DWORD PTR _hMem$[ebp]
; Line 120
