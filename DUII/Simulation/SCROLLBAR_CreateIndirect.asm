; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\Widget\SCROLLBAR_CreateIndirect.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	_SCROLLBAR_CreateIndirect
EXTRN	_SCROLLBAR_CreateEx:PROC
EXTRN	__RTC_CheckEsp:PROC
EXTRN	__RTC_Shutdown:PROC
EXTRN	__RTC_InitBase:PROC
;	COMDAT rtc$TMZ
; File c:\duii\simulation\gui\widget\scrollbar_createindirect.c
rtc$TMZ	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT _SCROLLBAR_CreateIndirect
_TEXT	SEGMENT
_hThis$ = -8						; size = 4
...
_y0$ = 20						; size = 4
_cb$ = 24						; size = 4
_SCROLLBAR_CreateIndirect PROC				; COMDAT
; Line 37
	push	ebp
	mov	ebp, esp
...
; Line 43
	...
	pop	ebp
	ret	0
_SCROLLBAR_CreateIndirect ENDP
_TEXT	ENDS
END
