; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\Widget\MULTIPAGE_CreateIndirect.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	_MULTIPAGE_CreateIndirect
EXTRN	_MULTIPAGE_CreateEx:PROC
EXTRN	__RTC_CheckEsp:PROC
EXTRN	__RTC_Shutdown:PROC
EXTRN	__RTC_InitBase:PROC
;	COMDAT rtc$TMZ
; File c:\duii\simulation\gui\widget\multipage_createindirect.c
rtc$TMZ	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT _MULTIPAGE_CreateIndirect
_TEXT	SEGMENT
_hThis$ = -8						; size = 4
...
_y0$ = 20						; size = 4
_cb$ = 24						; size = 4
_MULTIPAGE_CreateIndirect PROC				; COMDAT
; Line 38
	push	ebp
	mov	ebp, esp
...
; Line 44
	...
	pop	ebp
	ret	0
_MULTIPAGE_CreateIndirect ENDP
_TEXT	ENDS
END
