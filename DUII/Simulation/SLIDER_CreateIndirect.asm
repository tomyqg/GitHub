; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\Widget\SLIDER_CreateIndirect.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	_SLIDER_CreateIndirect
EXTRN	_SLIDER_CreateEx:PROC
EXTRN	__RTC_CheckEsp:PROC
EXTRN	__RTC_Shutdown:PROC
EXTRN	__RTC_InitBase:PROC
;	COMDAT rtc$TMZ
; File c:\duii\simulation\gui\widget\slider_createindirect.c
rtc$TMZ	SEGMENT
...
_y0$ = 20						; size = 4
_cb$ = 24						; size = 4
_SLIDER_CreateIndirect PROC				; COMDAT
; Line 37
	push	ebp
	mov	ebp, esp
