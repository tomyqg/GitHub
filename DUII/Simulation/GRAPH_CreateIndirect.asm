; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\Widget\GRAPH_CreateIndirect.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	_GRAPH_CreateIndirect
EXTRN	_GRAPH_CreateEx:PROC
EXTRN	__RTC_CheckEsp:PROC
EXTRN	__RTC_Shutdown:PROC
EXTRN	__RTC_InitBase:PROC
;	COMDAT rtc$TMZ
; File c:\duii\simulation\gui\widget\graph_createindirect.c
rtc$TMZ	SEGMENT
...
_y0$ = 20						; size = 4
_cb$ = 24						; size = 4
_GRAPH_CreateIndirect PROC				; COMDAT
; Line 38
	push	ebp
	mov	ebp, esp
