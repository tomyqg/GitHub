; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\Widget\LISTVIEW_CreateIndirect.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	_LISTVIEW_CreateIndirect
EXTRN	_LISTVIEW_CreateEx:PROC
EXTRN	__RTC_CheckEsp:PROC
EXTRN	__RTC_Shutdown:PROC
EXTRN	__RTC_InitBase:PROC
;	COMDAT rtc$TMZ
; File c:\duii\simulation\gui\widget\listview_createindirect.c
rtc$TMZ	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT _LISTVIEW_CreateIndirect
_TEXT	SEGMENT
_hThis$ = -8						; size = 4
...
_y0$ = 20						; size = 4
_cb$ = 24						; size = 4
_LISTVIEW_CreateIndirect PROC				; COMDAT
; Line 37
	push	ebp
	mov	ebp, esp
