; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\Widget\GUI_DRAW_BMP.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
;	COMDAT rtc$TMZ
; File c:\duii\simulation\gui\widget\gui_draw_bmp.c
rtc$TMZ	SEGMENT
...
__GetYSize ENDP
_TEXT	ENDS
PUBLIC	_GUI_DRAW_BMP_Create
EXTRN	_GUI_ALLOC_AllocZero:PROC
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT _GUI_DRAW_BMP_Create
_TEXT	SEGMENT
_pObj$10186 = -20					; size = 4
_hMem$ = -8						; size = 4
_pBMP$ = 8						; size = 4
_x$ = 12						; size = 4
_y$ = 16						; size = 4
_GUI_DRAW_BMP_Create PROC				; COMDAT
; Line 103
	push	ebp
	mov	ebp, esp
	sub	esp, 216				; 000000d8H
...
; Line 106
	...
	je	SHORT $LN1@GUI_DRAW_B
; Line 109
	mov	eax, DWORD PTR _hMem$[ebp]
	push	eax
	call	_GUI_ALLOC_LockH
	add	esp, 4
	mov	DWORD PTR _pObj$10186[ebp], eax
; Line 110
	mov	eax, DWORD PTR _pObj$10186[ebp]
...
; Line 114
	call	_GUI_ALLOC_UnlockH
	mov	DWORD PTR _pObj$10186[ebp], 0
$LN1@GUI_DRAW_B:
; Line 117
	mov	eax, DWORD PTR _hMem$[ebp]
; Line 118
