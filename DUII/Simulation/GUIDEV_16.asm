; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\MemDev\GUIDEV_16.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	_GUI_MEMDEV_DEVICE_16
_DATA	SEGMENT
$SG9999	DB	'_XY2PTR: parameters out of bounds', 00H
	ORG $+2
$SG10030 DB	'GUIDEV.c: DrawBitLine1BPP, Act= %d, Border= %d, Clip= %d'
	DB	00H
_DATA	ENDS
CONST	SEGMENT
_aID	DD	00H
...
_xsize$ = 28						; size = 4
_pDest$ = 32						; size = 4
__DrawBitLine16BPP_DDB PROC				; COMDAT
; File c:\duii\simulation\gui\memdev\guidev_16.c
; Line 51
	push	ebp
	mov	ebp, esp
...
; Line 59
	...
	pop	ebp
	ret	0
__DrawBitLine16BPP_DDB ENDP
; Function compile flags: /Odtp /RTCsu /ZI
_TEXT	ENDS
;	COMDAT __DrawBitLine32BPP
_TEXT	SEGMENT
_Index$9984 = -20					; size = 2
_Color$9983 = -8					; size = 4
_pDevice$ = 8						; size = 4
_pUsage$ = 12						; size = 4
_x$ = 16						; size = 4
_y$ = 20						; size = 4
...
; Line 75
	...
	mov	DWORD PTR _Color$9983[ebp], ecx
; Line 76
	mov	esi, esp
	mov	eax, DWORD PTR _Color$9983[ebp]
	push	eax
	mov	ecx, DWORD PTR _pDevice$[ebp]
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	WORD PTR _Index$9984[ebp], ax
; Line 77
	mov	eax, DWORD PTR _pDest$[ebp]
	mov	cx, WORD PTR _Index$9984[ebp]
	mov	WORD PTR [eax], cx
; Line 78
	cmp	DWORD PTR _pUsage$[ebp], 0
...
; Line 215
	...
	je	SHORT $PixelLoopWrite$10101
	cmp	DWORD PTR tv72[ebp], 1
	je	$PixelLoopXor$10117
	cmp	DWORD PTR tv72[ebp], 2
	je	SHORT $PixelLoopTrans$10108
	jmp	$LN24@DrawBitLin@4
$PixelLoopWrite$10101:
; Line 218
...
; Line 228
	...
	mov	BYTE PTR _pixels$[ebp], dl
; Line 229
	jmp	SHORT $PixelLoopWrite$10101
$LN16@DrawBitLin@4:
; Line 231
	jmp	$LN24@DrawBitLin@4
$PixelLoopTrans$10108:
; Line 234
	movzx	eax, BYTE PTR _PixelCnt$[ebp]
	cmp	eax, DWORD PTR _xsize$[ebp]
...
; Line 301
	mov	eax, DWORD PTR _xsize$[ebp]
	sar	eax, 1
	mov	DWORD PTR _i$10153[ebp], eax
; Line 302
	mov	eax, DWORD PTR _xsize$[ebp]
	and	eax, 1
	mov	DWORD PTR _xsize$[ebp], eax
...
; Line 307
	...
	mov	BYTE PTR _pixels$[ebp], dl
; Line 308
	mov	eax, DWORD PTR _i$10153[ebp]
	sub	eax, 1
	mov	DWORD PTR _i$10153[ebp], eax
...
; Line 578
	mov	eax, DWORD PTR _pDest$[ebp]
	movzx	ecx, WORD PTR [eax]
	movzx	edx, WORD PTR _IndexMask$[ebp]
	xor	ecx, edx
	mov	eax, DWORD PTR _pDest$[ebp]
	mov	WORD PTR [eax], cx
; Line 579
...
; Line 585
	mov	eax, DWORD PTR _Len$[ebp]
	push	eax
	movzx	ecx, WORD PTR _ColorIndex$[ebp]
	push	ecx
	mov	edx, DWORD PTR _pData$[ebp]
	push	edx
	call	_GUI__memset16
