; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\Widget\TREEVIEW_CreateIndirect.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	_TREEVIEW_CreateIndirect
EXTRN	_TREEVIEW_CreateEx:PROC
EXTRN	__RTC_CheckEsp:PROC
EXTRN	__RTC_Shutdown:PROC
EXTRN	__RTC_InitBase:PROC
;	COMDAT rtc$TMZ
; File c:\duii\simulation\gui\widget\treeview_createindirect.c
rtc$TMZ	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT _TREEVIEW_CreateIndirect
_TEXT	SEGMENT
_hThis$ = -8						; size = 4
...
_y0$ = 20						; size = 4
_cb$ = 24						; size = 4
_TREEVIEW_CreateIndirect PROC				; COMDAT
; Line 37
	push	ebp
	mov	ebp, esp
