; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\Widget\LISTVIEW_SetRBorder.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
;	COMDAT rtc$TMZ
; File c:\duii\simulation\gui\widget\listview_setrborder.c
rtc$TMZ	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT _LISTVIEW_SetRBorder
_TEXT	SEGMENT
_pObj$14698 = -8					; size = 4
_hObj$ = 8						; size = 4
_BorderSize$ = 12					; size = 4
_LISTVIEW_SetRBorder PROC				; COMDAT
; Line 37
	push	ebp
	mov	ebp, esp
