...
static void _FillRect(GUI_DEVICE * pDevice, int x0, int y0, int x1, int y1) {
  ...
  if (GUI_Context.DrawMode & LCD_DRAWMODE_XOR) {
    ...
    //
    temp = y0;
    y0 = (pContext->vySize - 1 - y1);
    y1 = (pContext->vySize - 1 - temp);
    //
    // Draw...
    //
    do {
...
void GUIDRV_Lin_OXY_16_C(void);   // Avoid empty object files
void GUIDRV_Lin_OXY_16_C(void) {}
