; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\Core\GUI_SetOrientationC8.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	_GUI_OrientationAPI_C8
CONST	SEGMENT
_GUI_OrientationAPI_C8 DD FLAT:__DrawBitmap_CX
...
; Line 351
	mov	eax, DWORD PTR _pData$[ebp]
	add	eax, DWORD PTR _PixelOffset$[ebp]
	mov	DWORD PTR _pData$[ebp], eax
; Line 352
	mov	eax, DWORD PTR _xsize$[ebp]
	sub	eax, 1
