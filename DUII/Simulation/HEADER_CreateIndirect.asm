; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\DUII\Simulation\GUI\Widget\HEADER_CreateIndirect.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	_HEADER_CreateIndirect
EXTRN	_HEADER_CreateEx:PROC
EXTRN	__RTC_CheckEsp:PROC
EXTRN	__RTC_Shutdown:PROC
EXTRN	__RTC_InitBase:PROC
;	COMDAT rtc$TMZ
; File c:\duii\simulation\gui\widget\header_createindirect.c
rtc$TMZ	SEGMENT
...
_y0$ = 20						; size = 4
_cb$ = 24						; size = 4
_HEADER_CreateIndirect PROC				; COMDAT
; Line 37
	push	ebp
	mov	ebp, esp
